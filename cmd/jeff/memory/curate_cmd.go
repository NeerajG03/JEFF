...
processed entries. Marlowe writes canonical entries via 'jeff memory add'.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if provider.BuildCurateArgs("") == nil {
...
func init() {
	...
	curateCmd.Flags().BoolVar(&curateFlags.auto, "auto", false, "non-interactive: flag conflicts in report instead of prompting")
