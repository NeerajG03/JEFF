...
func TestDefaultRegistryHasBuiltins(t *testing.T) {
	...
	expected := []string{"checkpoint-nudge", "crew-context", "gig-instructions", "gig-ready-tasks", "inbox-check", "jeff-instructions", "jeff-repos", "orchestrator-inbox", "task-commands", "task-context", "worker-heartbeat", "worker-stop"}
	names := r.Names()
